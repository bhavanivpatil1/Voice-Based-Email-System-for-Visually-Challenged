...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            def nam():
                return name
            texttospeech("Congratulations {name}. You have logged in successfully. You will now be redirected to the menu page.", file + i)
            i = i + str(1)
...
def options_view(request):
    ...
    if request.method == 'POST':
        ...
        while(flag):
            ...
            i = i + str(1)
            say = speechtotext(3)
            if say == 'No' or say == 'no' or say == 'nope' :
                flag = False
